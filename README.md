...
- 已注册并可批量导出的因子：190 个，其中 63 个使用当前 20 只研究股票的日度横截面计算。
...
# 基于 data/price/ 中的行情生成 190 份因子长表
...
- [最新 190 因子覆盖扩展](docs/updates/2026-07-23-190-factor-coverage-extension.md)
- [架构决策记录](docs/adr/)
...
- 190 个因子已注册，但大多数尚缺独立数值基准测试；仅 `Alpha30` 仍待实现。
