...
当前已注册因子：`Alpha2`、`Alpha3`、`Alpha5`、`Alpha9`、`Alpha11`、`Alpha14`、
`Alpha15`、`Alpha20`、`Alpha29`、`Alpha31`、`Alpha40`、`Alpha43`、`Alpha46`、
`Alpha53`、`Alpha60`、`Alpha69`、`Alpha80`、`Alpha84`、`Alpha168`、`Alpha191`。
...
- [最新因子扩展更新](docs/updates/2026-07-20-factor-expansion.md)
- [架构决策记录](docs/adr/)
...
- 20 个因子可运行，但大多数尚缺独立数值基准测试；其余 191 因子仍在规划或实现中。
