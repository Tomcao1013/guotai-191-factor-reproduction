...
- 行情数据包含前复权 OHLC、同尺度 `vwap`、原始成交量和成交额。

当前注册表包含 70 个可批量导出的单股票时间序列因子。完整清单见
...
- [最新 VWAP/AMOUNT 与 70 因子更新](docs/updates/2026-07-21-vwap-amount-extension.md)
- [架构决策记录](docs/adr/)
...
- 70 个因子可运行，但大多数尚缺独立数值基准测试；其余 191 因子仍在规划或实现中。
