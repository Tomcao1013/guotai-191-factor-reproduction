...
- 已注册并可批量导出的因子：132 个，其中 6 个使用当前 20 只研究股票的日度横截面计算。
...
# 基于 data/price/ 中的行情生成 132 份因子长表
...
- [最新 132 因子覆盖扩展](docs/updates/2026-07-22-132-factor-expansion.md)
- [架构决策记录](docs/adr/)
...
- 132 个因子可运行，但大多数尚缺独立数值基准测试；其余 59 个因子仍在规划或实现中。
