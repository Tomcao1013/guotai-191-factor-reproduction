...
当前注册表包含 99 个可批量导出的因子，其中 6 个因子使用当前 20 只研究股票的日度横截面计算。完整清单见
...
- [最新横截面、基准数据与 99 因子更新](docs/updates/2026-07-21-panel-benchmark-extension.md)
- [架构决策记录](docs/adr/)
...
- 99 个因子可运行，但大多数尚缺独立数值基准测试；其余 191 因子仍在规划或实现中。
